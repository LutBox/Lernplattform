	...
	<main class="fade-in">
		<form id="aenderungsformular" method="post"
			...
			<fieldset>
				...
				<div>
					<label for="neueEmail">Neue E-Mail</label> <input
				...
				<div>
					<label>Status</label>
					 <input type="radio"
						name="nutzerart" id="regnutzer" value="0" /><label for="regnutzer">Nutzer</label>
					 <input type="radio"
						name="nutzerart" value="1" id="administrator" /><label for="administrator">Admin</label>
				</div>
				<div>
				...
				<div class="buttonbox">
					...
					<a class="buttonLink" class="linkZuButton" href="./suchergebnisse.jsp">Zurück zu den Suchergebnissen</a>
				</div>
			</fieldset>
		</form>
		<div id="infotext">
