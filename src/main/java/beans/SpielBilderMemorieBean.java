...
public class SpielBilderMemorieBean implements Serializable {
	...
	public void setBild2Stream(String bild2Stream) {
		this.bild2Stream = bild2Stream;
	}

	public String getBild3Stream() {
		return bild3Stream;
	}

	public void setBild3Stream(String bild3Stream) {
		this.bild3Stream = bild3Stream;
	}

	public String getBild4Stream() {
		return bild4Stream;
	}

	public void setBild4Stream(String bild4Stream) {
		this.bild4Stream = bild4Stream;
	}

	public String getBild5Stream() {
		return bild5Stream;
	}

	public void setBild5Stream(String bild5Stream) {
		this.bild5Stream = bild5Stream;
	}

	public String getBild6Stream() {
		return bild6Stream;
	}

	public void setBild6Stream(String bild6Stream) {
		this.bild6Stream = bild6Stream;
	}

	public String getBild7Stream() {
		return bild7Stream;
	}

	public void setBild7Stream(String bild7Stream) {
		this.bild7Stream = bild7Stream;
	}

	public String getBild8Stream() {
		return bild8Stream;
	}

	public void setBild8Stream(String bild8Stream) {
	...
	public void setBild2Kategorie(String bild2Kategorie) {
		this.bild2Kategorie = bild2Kategorie;
	}

	public String getBild3Kategorie() {
		return bild3Kategorie;
	}

	public void setBild3Kategorie(String bild3Kategorie) {
		this.bild3Kategorie = bild3Kategorie;
	}

	public String getBild4Kategorie() {
		return bild4Kategorie;
	}

	public void setBild4Kategorie(String bild4Kategorie) {
		this.bild4Kategorie = bild4Kategorie;
	}

	public String getBild5Kategorie() {
		return bild5Kategorie;
	}

	public void setBild5Kategorie(String bild5Kategorie) {
		this.bild5Kategorie = bild5Kategorie;
	}

	public String getBild6Kategorie() {
		return bild6Kategorie;
	}

	public void setBild6Kategorie(String bild6Kategorie) {
		this.bild6Kategorie = bild6Kategorie;
	}

	public String getBild7Kategorie() {
		return bild7Kategorie;
	}

	public void setBild7Kategorie(String bild7Kategorie) {
		this.bild7Kategorie = bild7Kategorie;
	}

	public String getBild8Kategorie() {
		return bild8Kategorie;
	}
	...
	public void setBild2ID(long bild2id) {
		bild2ID = bild2id;
	}

	public long getBild3ID() {
		return bild3ID;
	}

	public void setBild3ID(long bild3id) {
		bild3ID = bild3id;
	}

	public long getBild4ID() {
		return bild4ID;
	}

	public void setBild4ID(long bild4id) {
		bild4ID = bild4id;
	}

	public long getBild5ID() {
		return bild5ID;
	}

	public void setBild5ID(long bild5id) {
		bild5ID = bild5id;
	}

	public long getBild6ID() {
		return bild6ID;
	}

	public void setBild6ID(long bild6id) {
		bild6ID = bild6id;
	}

	public long getBild7ID() {
		return bild7ID;
	}

	public void setBild7ID(long bild7id) {
		bild7ID = bild7id;
	}

	public long getBild8ID() {
		return bild8ID;
	}

	public void setBild8ID(long bild8id) {
		bild8ID = bild8id;
	}
