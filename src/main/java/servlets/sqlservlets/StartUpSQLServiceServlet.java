...
/**
 * @author Merlin
 * @description Dieses Servlet wird beim Serverstart instanziiert (Siehe
 *              Annotation).
 */
...
public class StartUpSQLServiceServlet extends HttpServlet {
	...
	/**
	 * @author Merlin
	 * @description In dieser init() wird gleich nach dem Serverstart die
	 *              Datenquelle "ds" festgelegt und kann danach genutzt werden.
	 */
	@Override
