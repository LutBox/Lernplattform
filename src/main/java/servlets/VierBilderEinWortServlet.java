...
public class VierBilderEinWortServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String  kategorie;
		// 1) zuf�lliges Wort aus der Datenbank laden
		//Order by Rand() Limt 1//
		   ...
		   //  4) in request legen
		    ...
		    // 5) forward to jsp, damit die Bilder angezeig werden k�nnen
	...
	if (request.getParameter("userEingabe").equalsIgnoreCase(request.getParameter("loesung"))) {
	    ...
	    // mit neunen Daten neu aufgerufen :VierBilderEinWortServlet �ber js wird zum Ergebnis weitergeleitet
